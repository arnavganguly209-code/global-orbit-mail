...
export function mapMailbox(
  ...
  return {
    ...
    vacationEnabled: mailbox.vacationEnabled ?? false,
    vacationSubject: mailbox.vacationSubject ?? null,
    vacationBody: mailbox.vacationBody ?? null,
    vacationExpiresAt: mailbox.vacationExpiresAt?.toISOString() ?? null,
